...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
          ...
          live_grep_args = {
            ...
            mappings = {
              i = {
                ...
                -- ['<C-enter>'] = require('telescope-live-grep-args.actions').to_fuzzy_refine,
              },
            },
          },
        },
      ...
      vim.keymap.set('n', '<leader>sg', ext.live_grep_args.live_grep_args, { desc = '[S]earch by [G]rep (with args)' })
